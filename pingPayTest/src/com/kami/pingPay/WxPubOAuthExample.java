...
public class WxPubOAuthExample {
	 ...
	 * 微信用户在微信公共号的openId
	 */
	public static String openId="o5t0Hs8ahQe-u1jN65SrLD3LuanY";
	/**
	 * 微信公共号里面引导用户付款的网页url地址
	 * 该URL为付款当前网页地址
	 */
	public static String url = "http:\\\\api.51daixin.com\\pingPayTest";
	/**
	 * 微信公共号的appId
	 */
	public static String wx_app_id="wxc613c5012a22a0de";
	/**
	 * 微信公共号的secret
	 */
	public static String wx_app_secret ="unknown";
	/**
	 * @param args
	 */
